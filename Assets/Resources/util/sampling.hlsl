...
void SampleDistantLight(in Light light, in float3 scatterPos, inout LightSampleRec lightSample)
{
    lightSample.direction = normalize(light.position - float3(0.0));
...
void SampleOneLight(in Light light, in float3 scatterPos, inout LightSampleRec lightSample)
{
